...
import { CheckSquare, List, TrendingUp, Zap, Sparkles, Target } from "lucide-react";
                    ...
                    <div className="max-w-5xl mx-auto">
                        <div className="text-center mb-16 animate-in fade-in slide-in-from-bottom duration-700">
                            ...
                            <p className="text-xl text-slate-600 mb-10 max-w-2xl mx-auto leading-relaxed">
                                Kelola semua aktivitas Anda dengan mudah dan efisien. Mulai produktivitas Anda hari ini! ✨
                            </p>
                            <Button 
                            ...
                            <Card className="border-0 shadow-xl bg-gradient-to-br from-blue-500 to-indigo-600 text-white hover:scale-105 transition-all duration-300 group">
                                ...
                                <CardContent>
                                    <p className="text-blue-50 leading-relaxed">
                                        Interface yang intuitif membuat pengelolaan todos menjadi menyenangkan
                                    </p>
                                </CardContent>
                            </Card>
                            ...
                            <Card className="border-0 shadow-xl bg-gradient-to-br from-indigo-500 to-violet-600 text-white hover:scale-105 transition-all duration-300 group">
                                <CardHeader>
                                    <div className="flex items-center gap-4">
                                        ...
                                        <CardTitle className="text-xl">Statistik Real-time</CardTitle>
                                    </div>
                                </CardHeader>
                                <CardContent>
                                    <p className="text-indigo-50 leading-relaxed">
                                        Pantau progress aktivitas Anda dengan visualisasi data yang menarik
                                    </p>
                                </CardContent>
                            </Card>
                            ...
                            <Card className="border-0 shadow-xl bg-gradient-to-br from-violet-500 to-purple-600 text-white hover:scale-105 transition-all duration-300 group">
                                <CardHeader>
                                    <div className="flex items-center gap-4">
                                        ...
                                        <CardTitle className="text-xl">Cepat & Responsif</CardTitle>
                                    </div>
                                </CardHeader>
                                <CardContent>
                                    <p className="text-violet-50 leading-relaxed">
                                        Performa tinggi dengan teknologi modern Laravel + React
                                    </p>
                                </CardContent>
                            </Card>
                        </div>
                        ...
                        <Card className="shadow-2xl border-0 overflow-hidden">
                            <CardHeader className="bg-gradient-to-r from-blue-600 via-indigo-600 to-violet-600 text-white p-8">
                                <div className="flex items-center gap-3">
                                    ...
                                    <CardTitle className="text-3xl">Fitur Lengkap & Powerful</CardTitle>
                                </div>
                            </CardHeader>
                            <CardContent className="p-8 bg-gradient-to-br from-white to-blue-50">
                                <div className="grid md:grid-cols-2 gap-8">
                                    <div className="flex items-start gap-4 group">
                                        ...
                                        <div>
                                            <h4 className="font-bold text-lg mb-2 text-slate-800">CRUD Lengkap</h4>
                                            <p className="text-slate-600 leading-relaxed">Tambah, edit, hapus todos dengan mudah dan cepat</p>
                                        </div>
                                    </div>
                                    <div className="flex items-start gap-4 group">
                                        ...
                                        <div>
                                            <h4 className="font-bold text-lg mb-2 text-slate-800">Filter & Pencarian</h4>
                                            <p className="text-slate-600 leading-relaxed">Temukan todos dengan sistem pencarian yang canggih</p>
                                        </div>
                                    </div>
                                    <div className="flex items-start gap-4 group">
                                        ...
                                        <div>
                                            <h4 className="font-bold text-lg mb-2 text-slate-800">Statistik Visual</h4>
                                            <p className="text-slate-600 leading-relaxed">Chart interaktif dengan ApexCharts yang indah</p>
                                        </div>
                                    </div>
                                    <div className="flex items-start gap-4 group">
                                        ...
                                        <div>
                                            <h4 className="font-bold text-lg mb-2 text-slate-800">Drag & Drop</h4>
                                            <p className="text-slate-600 leading-relaxed">Susun ulang todos dengan drag and drop yang smooth</p>
                                        </div>
                                    </div>
                                </div>
                            </CardContent>
